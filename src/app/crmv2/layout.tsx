...
const navigation = [
  { name: 'Dashboard', href: '/crmv2', icon: Home },
  { name: 'Leads', href: '/crmv2/leads', icon: Users },
  { name: 'Opportunities', href: '/crmv2/opportunities', icon: Target },
  { name: 'Projects', href: '/crmv2/projects', icon: Building2 },
  { name: 'Reports', href: '/crmv2/reports', icon: BarChart3 },
  { name: 'Campaigns', href: '/crmv2/campaigns', icon: Mail },
  { name: 'Candidates', href: '/crmv2/candidates', icon: Briefcase },
];

export default function CRMv2Layout({
  children,
}: {
    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-400">Loading CRM v2...</p>
        </div>
      </div>
    );
  }
      ...
      >
        <div className="flex h-full flex-col">
          ...
          <div className="flex h-16 items-center justify-between border-b border-gray-700 px-6">
            <Link href="/crmv2" className="flex items-center space-x-2">
              ...
              <div>
                ...
                <p className="text-gray-400 text-xs">CRM v2</p>
              </div>
            </Link>
            <Button
              variant="ghost"
          ...
          <div className="border-t border-gray-700 p-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xs text-gray-400">v2.0 Beta</span>
              </div>
              <Link href="/crm">
        ...
        <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-gray-700 bg-gray-900 px-6">
          ...
          <div className="hidden lg:block">
            <div className="flex items-center space-x-2 text-sm">
              <Link href="/crmv2" className="text-gray-400 hover:text-white transition-colors">
                CRM v2
              </Link>
              {pathname !== '/crmv2' && (
                <>
