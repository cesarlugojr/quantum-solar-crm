...
import { MetricsCards } from '@/components/crmv2/executive-dashboard/MetricsCards';
import { MetricsCardsSkeleton, ChartSkeleton } from '@/components/crmv2/LoadingSkeletons';

export const metadata: Metadata = {
  title: 'Dashboard | Quantum Solar CRM v2',
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 mt-1">
            Welcome to Quantum Solar CRM v2 - Your solar business command center
          </p>
        </div>
      </div>
