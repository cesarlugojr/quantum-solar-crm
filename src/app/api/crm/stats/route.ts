 ...
 * CRM Stats API Route
 *
 * Provides dashboard statistics and analytics for the CRM system.
 * Includes project counts, revenue metrics, and performance indicators.
 */
...
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('Error in CRM stats API:', error);
    return NextResponse.json({
      data: {
        total_projects: 0,
        active_projects: 0,
