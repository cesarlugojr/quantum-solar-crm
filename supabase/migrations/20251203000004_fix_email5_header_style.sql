-- ============================================================================
-- QUANTUM SOLAR - FIX #5 EMAIL HEADER TO MATCH OTHER EMAILS
-- Purpose: Update #5 email headers to have same style as #1-4
-- - Add dark gradient background
-- - Center logo
-- - Add "POWERING ILLINOIS HOMES" tagline
-- ============================================================================
...
BEGIN
  RAISE NOTICE '============================================================================';
  RAISE NOTICE 'EMAIL #5 HEADER STYLE FIXED';
  RAISE NOTICE '============================================================================';
  RAISE NOTICE 'Added: Dark gradient background, centered logo, tagline';
